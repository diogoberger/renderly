export const metadata = {
  title: 'HTML to PDF in Python — Renderly API',
  description: 'Generate PDFs from HTML in Python with requests. No WeasyPrint, no system dependencies, no Chromium binary.',
};

export default function PythonPDFPage() {
  return (
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .lang-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(59,130,246,0.12);border:1px solid rgba(59,130,246,0.3);color:#93C5FD;padding:5px 14px;border-radius:100px;font-size:12px;font-weight:600;margin-bottom:20px}
      ...
      <div className="container">
        <section className="hero">
          <div className="lang-badge">🐍 Python</div>
          <h1>HTML to PDF in <span>Python</span></h1>
          <p>Generate PDFs from HTML in your Django, Flask, or FastAPI app with a single requests call. No WeasyPrint, no GTK/Cairo system libraries, no Chromium binary to manage.</p>
        ...
        <section className="section">
          ...
          <p className="section-sub">Requires only the <code style={{color:'#86EFAC',fontFamily:'monospace'}}>requests</code> library — already in most Python projects.</p>
          <div className="code-block">
            <div className="code-header">
              <span className="dot dot-r"/><span className="dot dot-y"/><span className="dot dot-g"/>
              <span className="code-title">generate_pdf.py</span>
            </div>
...
<span class="fn">print</span>(<span class="str">"PDF saved!"</span>)`}</pre>
          </div>
        </section>

        <section className="section">
          <h2 className="section-title">Django view example</h2>
          <div className="code-block">
            <div className="code-header">
              <span className="dot dot-r"/><span className="dot dot-y"/><span className="dot dot-g"/>
              <span className="code-title">views.py</span>
            </div>
            <pre>{`<span class="kw">from</span> django.http <span class="kw">import</span> HttpResponse
